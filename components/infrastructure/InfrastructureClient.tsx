        ...
        <div className="min-h-screen bg-white">
            ...
            <section className="relative h-[50vh] min-h-[400px] flex items-center justify-center overflow-hidden">
                <div className="absolute inset-0 z-0">
                    <Image
                        src="/images/hero-bg-blue.png" // Reusing the high-quality hero bg for consistency/theme
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
                    ...
                    >
                        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 backdrop-blur-md border border-white/20 mb-6">
                            <Factory className="w-4 h-4 text-accent-royal" />
            ...
            <section className="py-16 bg-charcoal relative overflow-hidden">
                <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-accent-royal/5 rounded-full blur-[100px] mix-blend-screen opacity-50"></div>
                <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-accent-navy/5 rounded-full blur-[100px] mix-blend-screen opacity-50"></div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="grid md:grid-cols-4 gap-8">
                        {[
                            ...
                            >
                                <div className="w-16 h-16 bg-gradient-to-br from-accent-navy to-accent-royal rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform shadow-lg">
                                    <stat.icon className="w-8 h-8 text-white" />
                                </div>
                                <div className="text-3xl font-bold text-white mb-1">
                                    {stat.value}<span className="text-accent-royal">{stat.suffix}</span>
                                </div>
            ...
            <section className="py-24 bg-gray-50 relative">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl md:text-5xl font-bold text-charcoal mb-6">Advanced <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent-navy to-accent-royal">Technology</span></h2>
                    ...
                    <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                        {[
                            ...
                            { icon: Zap, title: "Bottom & Side Sealing Machines", desc: "Advanced sealing technology for secure and efficient bag production with precision bottom and side sealing capabilities." }
                        ].map((item, index) => (
                            <motion.div
                                key={item.title}
                            ...
                            >
                                <div className="w-12 h-12 bg-accent-royal/10 rounded-xl flex items-center justify-center mb-6 text-accent-royal group-hover:bg-accent-royal group-hover:text-white transition-colors">
            ...
            <section className="py-24 bg-white relative overflow-hidden">
                <div className="absolute inset-0 bg-accent-navy/5 skew-y-3 transform origin-bottom-right"></div>
