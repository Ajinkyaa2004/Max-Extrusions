    ...
    return (
        <section ref={ref} className="py-20 bg-white relative overflow-hidden">
            ...
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full max-w-7xl pointer-events-none">
                <div className="absolute top-1/4 left-10 w-64 h-64 bg-accent-royal/5 rounded-full blur-3xl" />
                <div className="absolute bottom-1/4 right-10 w-64 h-64 bg-accent-navy/5 rounded-full blur-3xl" />
            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                >
                    <span className="text-accent-royal font-semibold tracking-wider uppercase text-sm">Our Impact</span>
                    <h2 className="mt-2 text-3xl md:text-5xl font-bold text-gray-900">
                        Numbers that Speak for <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent-navy to-accent-royal">Themselves</span>
                    </h2>
                </motion.div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {stats.map((stat, index) => (
                        ...
                        >
                            <div className="w-16 h-16 mx-auto bg-white rounded-2xl shadow-sm flex items-center justify-center mb-6 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 text-accent-navy border border-gray-100">
                                <stat.icon className="w-7 h-7" />
                            </div>

                            <div className="flex items-center justify-center gap-1 mb-2">
                                <span className="text-4xl md:text-5xl font-extrabold text-gray-900">{stat.value}</span>
                                <span className="text-2xl font-bold text-accent-royal self-start mt-1">{stat.suffix}</span>
                            </div>
