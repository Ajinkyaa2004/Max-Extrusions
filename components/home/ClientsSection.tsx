...
export default function StatsSection() {
    return (
        <section className="py-24 bg-white relative overflow-hidden">
            {/* Background Decor */}
            <div className="absolute top-0 right-0 w-96 h-96 bg-accent-navy/5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2" />
            <div className="absolute bottom-0 left-0 w-96 h-96 bg-accent-royal/5 rounded-full blur-3xl translate-y-1/2 -translate-x-1/2" />
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="grid md:grid-cols-2 gap-16 items-center">
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                    >
                        <div className="inline-flex items-center gap-2 text-accent-royal font-semibold tracking-wider uppercase text-sm mb-4">
                        ...
                        <ul className="space-y-4">
                            {clients.map((client, index) => (
                                <motion.li
                                    ...
                                    className="flex items-center gap-3 p-3 bg-white rounded-lg border border-gray-100 hover:border-accent-royal/30 transition-colors"
                                >
                                    <span className="w-2 h-2 rounded-full bg-accent-royal" />
